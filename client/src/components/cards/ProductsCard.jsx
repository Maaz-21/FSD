...
import { CircularProgress, Rating } from "@mui/material";  // Rating is a component from Material UI
import {
...
const ProductsCard = ({ product }) => {
  ...
  useEffect(() => {
    checkFavorite(); // checkFavorite function is called whenever the component is mounted
  }, [favorite]);    // A dependency array is passed to useEffect, which means useEffect will run whenever the value of favorite changes
  return (
    <Card>
      <Top>
