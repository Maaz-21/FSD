...
import { DeleteOutline } from "@mui/icons-material";     //Material UI icon for a delete button.
...
const Cart = () => {
  ...
  useEffect(() => {  // useEffect to get the products in the cart when the page loads
    getProducts();
  }, [reload]);
        ...
        {loading ? (
          ...
          <>
            {products.length === 0 ? (
              ...
              <Wrapper>
                <Left>                            {/* Left side holds cart items */}
                  <Table>
                    <TableItem bold flex>
                      Product
                    </TableItem>
                ...
                <Right>          {/* Right holds subtotal, delivery, and payment details */}
                  <Subtotal>
